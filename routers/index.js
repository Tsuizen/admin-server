...
// 添加用户
router.post('/manage/user/add', auth, (req, res) => {
  // 读取请求参数数据
  const { username, password } = req.body;
...
// 更新产品
router.post('/manage/product/update', auth, (req, res) => {
  const product = req.body;
...
// 更新角色(设置权限)
router.post('/manage/role/update', auth, (req, res) => {
  const role = req.body;
